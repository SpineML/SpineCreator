...
macx {
    ...
    QMAKE_CXXFLAGS += -O0 -g
    LIBS +=  -L/usr/local/lib/ -L/usr/local/lib/graphviz/ -lpython2.7 # -L/opt/local/lib/ # this causes libJPEG.dylib conflict and is not required.
    ...
    INCLUDEPATH += /usr/local/include /usr/local/include/graphviz
