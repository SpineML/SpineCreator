...
% My sample experiment has 2 neurons in its single population and
% requires 3000 points for each neuron. Here are two sines with 3000
% points describing about 4 3/4 periods, one larger in amplitude than
% the other:
...
% which is called "realtime". This is the name that you give to the
% connection when you create it in the SpineCreator "Experiment UI"
