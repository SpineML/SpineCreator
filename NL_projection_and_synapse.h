...
public:
    ...
    ~synapse();
    QSharedPointer<ComponentInstance> postSynapseCmpt; // refactor to postSynapseCmpt
    QSharedPointer<ComponentInstance> weightUpdateCmpt; // refactor to weightUpdateCmpt
